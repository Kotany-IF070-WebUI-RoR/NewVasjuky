...
issues = [
  { title: 'Прогнили дошки у проході між будинками',
    address: { lat: 48.9225648, lng: 24.710126,
               street_address: 'вул. Академіка Сахарова 23' },
    category: categories[20],
    description: 'У проході у внутрішній двір між будинками №3 та №5 '\
                 'на проспекті Грушевського прогнили дошки. '\
                 'Існує реальна загроза травмуватися для жильців та відвідувачів. '\
                 'Прохання замінити прогнилі дошки та укріпити прохід. '\
