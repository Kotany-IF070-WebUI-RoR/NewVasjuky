...
issues = [
  { title: 'Відсутній тротуар у проході між будинками',
    address: { lat: 48.9225649, lng: 24.710127,
...
{ title: 'Незаконний зал гральних автоматів',
  address: { lat: 48.92295045, lng: 24.7149093,
...
{ title: 'Зламане дерево нависає над пішохідною зоною',
  address: { lat: 48.92770050, lng: 24.71073927,
...
{ title: 'Дорога після прокладання каналізації',
  address: { lat: 48.92773575, lng: 24.72647310,
...
{ title: 'На зупинці відсутній сміттєвий бак',
  address: { lat: 48.90853657, lng: 24.71631647,
...
{ title: 'Самовільне встановлення лежачих поліцейських',
  address: { lat: 48.93360366, lng: 24.72393037,
...
{ title: 'Парковка відсутня',
  address: { lat: 48.92212799, lng: 24.7143818,
...
{ title: 'Дитячий майданчик',
  address: { lat: 48.93557357, lng: 24.74924506,
...
{ title: 'Стихійна торгівля в центральній частині міста!',
  address: { lat: 48.91939966, lng: 24.70837892,
...
{ title: 'Закинута будівля де живуть бомжі та наркомани',
  address: { lat: 48.91182019, lng: 24.73109723,
...
{ title: 'Вкрадений люк',
  address: { lat: 48.93679166, lng: 24.7450162,
...
{ title: 'Пішохідний перехід',
  address: { lat: 48.91996602, lng: 24.73392249,
...
{ title: 'Гральний заклад',
  address: { lat: 48.94352174, lng: 24.74672199,
...
{ title: 'Завалений прохід до тех. приміщення',
  address: { lat: 48.92388569, lng: 24.69689728,
...
{ title: "Забруднений паркан біля пам'ятки архітектури",
  ...
  description: 'На вул. Шевченка, біля пам\'ятки архітектури, яка входить у '\
               'спадщину ЮНЕСКО знаходиться в жахливому стані паркан. '\
               'Прохання очистити його та привести до естетичного вигляду.',
   issue_attachments_attributes: {
     attachment: Rack::Test::UploadedFile.new(
...
{ title: "Надання форми ялинкам",
  address: { lat: 48.9211467, lng: 24.7108565,
...
{ title: "Реклама на огорожі",
  address: { lat: 48.9211467, lng: 24.7108565,
             street_address: 'вул. Шашкевича 12' },
  category_id: 16,
  description: 'На вул. Шашкевича 12, знаходяться занедбана огорожа, '\
               'яка псує вигляд вулиці. '\
               'Прохання очистити огорожу від реклами, або прибрати її зовсім . Дякую.',
   issue_attachments_attributes: {
     attachment: Rack::Test::UploadedFile.new(
